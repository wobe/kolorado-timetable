...
(function () {
  ...
  var PLACEHOLDER_IMG  = "https://cdn.jsdelivr.net/gh/wobe/kolorado-timetable@main/wix-custom-element/artist-placeholder.png";
  ...
  var CSS = [
    ...
    ".kl-overlay{position:fixed;inset:0;background:rgba(100,44,255,0.70);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);z-index:9999;display:flex;align-items:center;justify-content:center;padding:16px;}",
    ...
    ".kl-popup-fav.off{background:#DCEA75;}",
    ".kl-popup-fav.on{background:#e86b5a;}",
    // Info body
    ...
    ".kl-nav-btn{flex-shrink:0;align-self:center;z-index:20;width:40px;height:40px;border-radius:50%;background:transparent;border:none;cursor:pointer;display:none;align-items:center;justify-content:center;color:#DCEA75;font-size:22px;font-weight:700;margin:0 4px;transition:opacity 0.15s;}",
