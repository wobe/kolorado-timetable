...
(function () {
  ...
  function _kapBuildPlayer(rawUrl) {
    ...
    if (/youtube\.com|youtu\.be/i.test(url)) {
      ...
      return '<div class="kap-player"><div style="position:relative;width:100%;padding-bottom:56.25%;"><iframe style="position:absolute;inset:0;width:100%;height:100%;display:block;" src="'+_kapEsc(ytSrc)+'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>';
    }
    return "";
  }
